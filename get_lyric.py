...
if __name__ == '__main__':
    ...
    scrapers = [www_lyrics_az(args.artist,args.song),j_lyric_net(args.artist,args.song),petitlyrics_com(args.artist,args.song)]
    
    if not is_all_ascii(args.artist) or not is_all_ascii(args.song):
